...
try: 
	...
	data = loader.load_file("/project/RDS-FEI-HospitalAdmissions-RW/ArtemisTraining/20Presenting/1.3IG/elevenFeatures.csv")
	...
	search = ASSearch(classname="weka.attributeSelection.Ranker", options=["-T", "-1.79", "-N", "5"])
